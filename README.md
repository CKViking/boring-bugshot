...
- Browser-Workspace fuer bis zu 30 Reports
- Download als gestaltete PDF, Markdown oder Issue-Text
...
- Screenshots werden an die OpenAI API gesendet, von Bugshot selbst aber nicht gespeichert.
